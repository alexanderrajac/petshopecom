...
import UpiPayment from "../order/UpiPayment";
                ...
                <Col>
                  ...
                  {order.paymentResult?.transactionId && (
                    <small className="d-block text-muted mb-2">
                      Ref/UTR: {order.paymentResult.transactionId}
                    </small>
                  )}
                  ...
                  {!order.isPaid &&
                    (order.paymentMethod?.includes("Google Pay") ||
                      order.paymentMethod?.includes("UPI")) && (
                      <div className="mt-3">
                        <UpiPayment order={order} onPaid={refetch} />
                      </div>
                    )}
